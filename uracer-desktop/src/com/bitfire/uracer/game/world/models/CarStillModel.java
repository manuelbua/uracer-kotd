...
public class CarStillModel extends OrthographicAlignedStillModel {
	...
	public void transform (PerspectiveCamera camPersp, OrthographicCamera camOrtho) {
		...
		// left tire
		{
			...
			Vector3 pos = transform(camPersp, camOrtho, state.position.x + dx, state.position.y + dy);
	...
	private Vector3 transform (PerspectiveCamera camPersp, OrthographicCamera camOrtho, float posPxX, float posPxY) {
